---
name: roadmap
description: Create PLAN from SPEC
...
`realizes_requirements: [FR-NNN, NFR-NNN]` (из source SPEC) — это обеспечивает
...
**realizes_requirements:** [FR-001, FR-005]      <!-- из SPEC секций 5/6 -->
```
