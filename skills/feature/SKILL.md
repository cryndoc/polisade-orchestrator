...
→ /polisade:tasks FEAT-XXX (для S/M)
→ /polisade:spec FEAT-XXX (если нужна архитектура)
```
...
═══════════════════════════════════════════
СЛЕДУЮЩИЙ ШАГ:
   → /polisade:tasks FEAT-001 — создать задачи и начать работу
   → /polisade:spec FEAT-001 — если нужна техническая проработка
...
- `/polisade:tasks` создаёт TASK, которые идут в `/polisade:implement`
