...
```bash
${POLISADE_PYTHON:-python3} {plugin_root}/scripts/polisade_acceptance.py template
```
...
чек:
    ${POLISADE_PYTHON:-python3} -m pytest tests/acceptance/test_order_total.py::test_empty_order_raises -q
──────────────────────────────────────────
...
```bash
${POLISADE_PYTHON:-python3} {plugin_root}/scripts/polisade_acceptance.py lint --root .
```
...
```bash
${POLISADE_PYTHON:-python3} {plugin_root}/scripts/polisade_acceptance.py digest --root . --save
```
...
```bash
${POLISADE_PYTHON:-python3} {plugin_root}/scripts/polisade_acceptance.py run --root .
${POLISADE_PYTHON:-python3} {plugin_root}/scripts/polisade_acceptance.py run --root . --only AC-001
```
...
```bash
${POLISADE_PYTHON:-python3} {plugin_root}/scripts/polisade_acceptance.py run --root . --fail-on-changed
```
