...
addresses: []                # [FR-NNN, NFR-NNN] требования, которые решает этот ADR
---
...
- {driver 1, например: "NFR-001: латентность p99 < 50ms (Performance)"}
- {driver 2, например: "должно работать оффлайн"}
- {driver 3, например: "NFR-003: 99.9% uptime (Reliability)"}
