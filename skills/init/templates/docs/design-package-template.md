...
**Source:** [[SPEC-XXX]] · **Generated:** YYYY-MM-DD via `/polisade:design`
...
> `/polisade:doctor`, `/polisade:review-pr`, `/polisade:roadmap` review. Markdown-таблица
...
|---|---|---|---|---|
| 1 | C4 Context (L1) | [c4-context.md](./c4-context.md) | SPEC-001.FR-001, SPEC-001.FR-002 | [причина из triggers] |
| 2 | C4 Container (L2) | [c4-container.md](./c4-container.md) | SPEC-001.FR-001..FR-007, SPEC-001.NFR-001 | [причина] |
| 3 | Sequence diagrams | [sequences.md](./sequences.md) | SPEC-001.FR-001, SPEC-001.FR-002, SPEC-001.NFR-002 | [причина] |
| 4 | ER + Data Dictionary | [data-model.md](./data-model.md) | SPEC-001.FR-001, SPEC-001.FR-003, SPEC-001.NFR-002 | [причина] |
| 5 | OpenAPI 3.0 | [api.md](./api.md) | SPEC-001.FR-001..FR-005, SPEC-001.NFR-001 | [причина] |
| 6 | Domain Glossary | [glossary.md](./glossary.md) | — (доменно-независим) | [причина] |
| 7 | Quality Scenarios | [quality-scenarios.md](./quality-scenarios.md) | SPEC-001.NFR-001..NFR-005 | [причина] |

<!--
Формат FR/NFR-ссылок в этой таблице И в `manifest.yaml` `artifacts[].realizes_requirements` —
composite: `{DOC_ID}.FR-NNN`. DOC_ID = `manifest.parent` (SPEC-XXX, PRD-XXX или FEAT-XXX).
Bare `FR-NNN` допустим только когда это FR объявлено ровно в одном top-level doc.
В frontmatter sub-artifact (c4-context.md, api.md, …) `realizes_requirements` должен
совпадать с manifest-значением после канонизации — lint ловит drift между ними.
-->
...
<!-- Если /polisade:design создал ADR — ссылки на них (они живут в docs/architecture/decisions/, не в этой папке) -->
...
- ✅ [manifest.yaml](./manifest.yaml) `artifacts[].realizes_requirements` совпадает с frontmatter каждого sub-artifact (composite IDs — lint ловит drift)
