...
ADRs (separate, in docs/architecture/decisions/):
  - docs/architecture/decisions/ADR-{N1}-{slug1}.md
  - docs/architecture/decisions/ADR-{N2}-{slug2}.md
```
...
2. ПОРЯДОК ГЕНЕРАЦИИ:
   ...
   i. ADRs (отдельные файлы в docs/architecture/decisions/)
