...
> `python3 {plugin_root}/scripts/polisade_corpus_io.py` (stdlib-only). Ни
...
1. Создай артефакт `docs/architecture/runs/ARCHRUN-NNN.md` (next-id по
   ...
   `python3 {plugin_root}/scripts/polisade_corpus_io.py write docs/architecture/runs/ARCHRUN-NNN.md --run-id <run-id> --from <staging-файл> --expect-absent`.
