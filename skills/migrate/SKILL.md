...
Status: up_to_date
Schema: 2, Polisade Orchestrator: 2.6.0
...
Current schema: 0 → Target: 2

Migrations:
  1. Add pdlcVersion: 2.6.0
  2. Update schemaVersion: 0 → 2
  3. Add lastUpdated: null
  4. Add settings.qualityGate: "codex"
  5. Create artifactIndex from file scan (15 artifacts)
