...
3. Если TASK нет — создать автоматически
...
[✓/✗] Каждое FR/NFR из требований реализовано в коде (поштучно):
       ✓/✗ FR-001: <EARS statement> → <file:function>
       ✓/✗ FR-002: <EARS statement> → <file:function>
       ... (по списку TASK.requirements)
...
def full_task_cycle(task_id):
    ...
    # 3a. Собрать тело PR в temp-файл, чтобы не попасть в quoting-ад
    #     с многострочным --body "...".
    PR_BODY_FILE = mktemp()
