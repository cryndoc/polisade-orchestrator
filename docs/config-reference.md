...
Plugin version covered: `2.23.2`. Schema version covered: `5`
...
|---|---|---|---|---|
| `pdlcVersion` | string | `"2.23.2"` (template) | SemVer `MAJOR.MINOR.PATCH` | Plugin version that wrote this state. Bumped on release; read by `pdlc_doctor`. |
