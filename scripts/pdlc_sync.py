...
def main():
    ...
    # .gitignore (delegates to compute_stage_paths in pdlc_migrate.py via
    ...
    from pdlc_migrate import compute_stage_paths
    ...
    # with pdlc_migrate.py (in case future sync code starts touching files
