...
CURRENT_POLISADE_VERSION = "3.8.6"
...
def plan_summary(migrations, touched_rel, pm_questions):
    ...
    head = ", ".join(parts)
    return "%s. Затронуто путей: %d. Вопросов PM: %d." % (
...
def main():
    ...
    if not migrations:
        ...
        print(json.dumps({
            ...
            "touched_paths": [],
            "stage_paths": [],
            "summary": plan_summary([], [], pm_questions),
